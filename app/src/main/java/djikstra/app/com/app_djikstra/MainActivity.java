...
//import djikstra.app.com.app_djikstra.R;
...
public class MainActivity extends FragmentActivity implements OnMapClickListener, OnMapLongClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapFragment mapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.peta);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (googleMap == null) {
            ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.peta)).getMapAsync((OnMapReadyCallback) this);
